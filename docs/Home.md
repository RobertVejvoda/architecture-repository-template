...
Detailed baseline, target, and transition architecture versions are tracked in [Architecture Version Register](./architecture/architecture-states/architecture-version-register).

...
<tr style="border:none;"><td style="border:none;padding:3px 16px 3px 0;"><strong>Architecture State</strong></td><td style="border:none;padding:3px 0;">Risk</td></tr>
...
| RISK-FS-001 | FairSpot sample: operations | Customer-ready deployment may be blocked if restore, monitoring, and support runbooks are not proven before go-live. | Medium | High | Link readiness evidence to work packages and deployment profile acceptance. | [Readiness](architecture/implementation-migration/readiness.md) | Platform Owner | YYYY-MM-DD | Open |

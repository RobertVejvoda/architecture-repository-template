...
| --- | --- | --- | --- | --- | --- | --- |
| Current State v0.1 | Baseline | Draft | YYYY-MM-DD | Current-state evidence. | [Baseline Architecture](/architecture/architecture-states/baseline-architecture) | Initial baseline placeholder. |
| Target State v0.1 | Target | Draft | YYYY-MM-DD | Future target architecture. | [Target Architecture](/architecture/architecture-states/target-architecture) | Initial target placeholder. |

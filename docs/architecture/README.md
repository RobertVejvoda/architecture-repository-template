...
- Track page-level status/version in the [Artifact Register](/architecture/artifact-register).
- Track named baseline and target snapshots in [Architecture States](/architecture/architecture-states/).

...
| Architecture Governance Framework | [Governance](architecture/governance/README.md), [Architecture Board](architecture/governance/architecture-board.md), [Architecture Review](architecture/governance/architecture-review.md), [Architecture Contract](architecture/governance/architecture-contract.md), [Change Control](architecture/governance/change-control.md), [Waivers](architecture/governance/waivers.md) | Planned | Define roles, reviews, conformance expectations, lifecycle, exceptions, and approval gates. |

...
| Requirements Repository | [Requirements](requirements.md) | Requirements Management | Cross-cutting | Draft | 0.1 | Architecture Owner | Architecture Board | - | - |
| Architecture Decisions | [Decisions](decisions.md) | Preliminary / Phase H | Cross-cutting | Draft | 0.1 | Architecture Owner | Architecture Board | - | - |
| Architecture Board | [Architecture Board](governance/architecture-board.md) | Preliminary / Phase G / Phase H | Cross-cutting | Draft | 0.1 | Architecture Owner | Architecture Board | - | - |
...
| Architecture Governance Framework | [Governance](governance/README.md), [Architecture Board](governance/architecture-board.md), [Architecture Review](governance/architecture-review.md), [Change Control](governance/change-control.md), [Waivers](governance/waivers.md) | Planned | Define roles, reviews, lifecycle, exceptions, and approval gates. |
...
| Architecture Contract | [Architecture Board](governance/architecture-board.md), [Architecture Review](governance/architecture-review.md), [Change Control](governance/change-control.md), [Waivers](governance/waivers.md) | Planned | Capture conformance expectations through review gates unless a formal contract is required. |

...
| Requirements Repository | [Requirements](./requirements.md) | Planned | Track architecture-significant requirements and link them to gaps/work packages. |

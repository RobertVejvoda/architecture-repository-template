...
When a sourcing option is selected, record the durable choice in [Architecture Decisions](/architecture/decisions.md) and update [Delivery Operating Model](/architecture/governance/delivery-operating-model.md).

...
Changes committed to the `master` branch are automatically published to GitHub Pages within a few minutes.
...
├── Home.md                         # Alias for home, used by sidebar link
...
```markdown
[Business Architecture](business/README.md)          <!-- missing architecture/ prefix -->
[Artifact Register](../artifact-register.md)         <!-- ../  breaks in Docsify -->
```
